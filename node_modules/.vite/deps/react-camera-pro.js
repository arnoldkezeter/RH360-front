...
var Wrapper = styled_components_browser_esm_default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n"])));
var Container = styled_components_browser_esm_default.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  width: 100%;\n  ", "\n"], [
  "\n  width: 100%;\n  ",
  "\n"
])), function(_a) {
...
var ErrorMsg = styled_components_browser_esm_default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  padding: 40px;\n"], ["\n  padding: 40px;\n"])));
var Cam = styled_components_browser_esm_default.video(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  z-index: 0;\n  transform: rotateY(", ");\n"], ["\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  z-index: 0;\n  transform: rotateY(", ");\n"])), function(_a) {
  var mirrored = _a.mirrored;
  return mirrored ? "180deg" : "0deg";
});
var Canvas = styled_components_browser_esm_default.canvas(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  display: none;\n"], ["\n  display: none;\n"])));
      ...
      switch (_a.label) {
        case 0:
          ...
          return [4, navigator.mediaDevices.enumerateDevices().then(function(devices) {
            var videoDevices = devices.filter(function(i2) {
              return i2.kind == "videoinput";
            });
...
var handleSuccess = function(stream, setNumberOfCameras) {
  navigator.mediaDevices.enumerateDevices().then(function(r2) {
    return setNumberOfCameras(r2.filter(function(i2) {
      return i2.kind === "videoinput";
    }).length);
  });
  return stream;
...
react-camera-pro/dist/index.esm.js:
  (*! *****************************************************************************
