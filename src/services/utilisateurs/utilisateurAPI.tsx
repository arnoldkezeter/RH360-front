...
export async function createUtilisateur({ matricule, nom, prenom, email, genre, role, telephone, dateNaissance, lieuNaissance, dateEntreeEnService, photoDeProfil, service, categorieProfessionnelle, posteDeTravail, commune, grade, familleMetier, actif, abreviationNoteServie}: Utilisateur, lang:string): Promise<ReponseApiPros> {
    try {
        const response: AxiosResponse<any> = await axios.post(
            `${api}/`,
            {matricule, nom, prenom, email, genre, role, telephone, dateNaissance, lieuNaissance, dateEntreeEnService, photoDeProfil, service, categorieProfessionnelle, posteDeTravail, commune, grade, familleMetier, actif, abreviationNoteServie},
            {
                headers: {
...
export async function updateUtilisateur({ _id,matricule, nom, prenom, email, genre, role, roles, telephone, dateNaissance, lieuNaissance, dateEntreeEnService, photoDeProfil, service, categorieProfessionnelle, posteDeTravail, commune, grade, familleMetier, actif, abreviationNoteServie }: Utilisateur, lang:string): Promise<ReponseApiPros> {
    try {
        const response: AxiosResponse<any> = await axios.put(
            `${api}/${_id}`,
            {matricule, nom, prenom, email, genre, role, roles, telephone, dateNaissance, lieuNaissance, dateEntreeEnService, photoDeProfil, service, categorieProfessionnelle, posteDeTravail, commune, grade, familleMetier, actif, abreviationNoteServie },
            {
                headers: {
                    'Content-Type': 'application/json',
                    'accept-language':lang,
