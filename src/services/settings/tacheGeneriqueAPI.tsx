...
export async function createTacheGenerique({nomFr, nomEn, ordre, niveau,descriptionFr, descriptionEn, type }: TacheGenerique, lang:string): Promise<ReponseApiPros> {
    try {
        const response: AxiosResponse<any> = await axios.post(
            `${api}/`,
            {nomFr, nomEn, ordre, niveau,descriptionFr, descriptionEn, type },
            {
                headers: {
...
export async function updateTacheGenerique({ _id, nomFr, nomEn, ordre,niveau, descriptionFr, descriptionEn, type }: TacheGenerique, lang:string): Promise<ReponseApiPros> {
    try {
