...
export async function createStage({ nomFr,nomEn,type,stagiaire,rotations, affectationsFinales, dateDebut, dateFin, anneeStage, statut}:CreateStageInput, lang:string): Promise<ReponseApiPros> {
  try {
    const response: AxiosResponse<any> = await axios.post(
            `${api}/`,
            {nomFr,nomEn,type,stagiaire,rotations, affectationsFinales, dateDebut, dateFin, anneeStage, statut},
            {
                headers: {
...
export async function updateStage({ nomFr,nomEn,type,stagiaire,rotations, affectationsFinales, dateDebut, dateFin, anneeStage, statut}:CreateStageInput,id:string, lang:string): Promise<ReponseApiPros> {
  try {
