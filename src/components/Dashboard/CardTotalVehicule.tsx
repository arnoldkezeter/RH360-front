...
// const CardTotalVehicule = () => {

//     const countTotalVehicule = useSelector((state: RootState) => state.vehicule.count);
...
//                 <svg viewBox="0 0 640 512" xmlns="http://www.w3.org/2000/svg" width="25"
//                     height="25" className="fill-primary dark:fill-white"
...
//                         {countTotalVehicule}
//                     </h4>
//                     <span className="text-sm font-medium">Total de véhicules</span>
//                 </div>
...
// export default CardTotalVehicule;
