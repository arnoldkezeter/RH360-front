...
import { changerStatutStage } from "../../../../services/chercheurs/stageRechercheAPI";

const ChangerStatutStage = ({ stage }:{stage:StageRecherche|undefined}) => {
    ...
    const handleSubmit = async () => {
        try {
            setIsLoading(true)
           await changerStatutStage({stageId:stage?._id||"", statut:statut, noteServiceFile:file, lang:lang}).then((e: ReponseApiPros) => {
                if (e.success) {
