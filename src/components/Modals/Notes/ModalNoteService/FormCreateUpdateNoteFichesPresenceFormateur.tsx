...
import {setShowModalFichePresenceFormateur } from '../../../../_redux/features/setting';
...
function FormCreateUpdateFichePresenceFormateur({tache, note, themeId }: {tache:TacheThemeFormation, note:NoteService|undefined, themeId?:string }) {
    ...
    const isModalOpen = useSelector((state: RootState) => state.setting.showModal.openFichePresenceFormateur);
...
export default FormCreateUpdateFichePresenceFormateur;
