...
import { setShowModalUploadDoc } from '../../../../_redux/features/setting';
import createToast from '../../../../hooks/toastify';
import CustomDialogModal from '../../CustomDialogModal';
import { Upload, File, X, CheckCircle, AlertCircle } from 'lucide-react';
import { validerNoteService } from '../../../../services/notes/noteServiceAPI';
import { updateNoteServiceSlice } from '../../../../_redux/features/notes/noteServiceSlice';



function FormUploadFile({ note }: { note: NoteService | null }) {
    ...
    const handleUpload = async () => {
        ...
        try {
            setIsLoading(true)
           await validerNoteService({
                noteId: note?._id||"",
                noteServiceFile:selectedFile,
                lang:lang
