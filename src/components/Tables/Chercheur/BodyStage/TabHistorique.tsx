...
const HistoriqueStageRecherches = ({ onEditStageRecherche }: HistoriqueStageRecherchesTabProps) => {
  ...
  const ActionMenu: React.FC<{ stageRecherche: StageRecherche }> = ({ stageRecherche }) => {
    ...
    const handleEdit = () => {
      if (onEditStageRecherche) {
        onEditStageRecherche(stageRecherche);
      }
      setIsOpen(false);
    };
        ...
        <div className="min-h-screen bg-[#F8FAFC] p-4 lg:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <p className="text-[#6B7280]">Gérez et suivez tous les mandats de recherche</p>
                    </div>
                </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                        type="text"
                        placeholder={`${t('recherche.rechercher')} ${t('recherche.mandat')}`}
                        value={searchTerm}
...
export default HistoriqueStageRecherches;