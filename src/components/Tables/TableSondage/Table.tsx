...
interface TableSondageProps {
    data: Sondage[];
    onCreate:()=>void;
    onEdit: (sondage:Sondage) => void;
    toDo: (sondage: Sondage) => void
}


const Table = ({ data, onCreate, onEdit, toDo }: TableSondageProps) => {
    ...
    // const [filtreSondage, setFiltreSondage] = useState("");
    ...
    // const handleSondageSelect = (selected: string) => {
    //     setFiltreSondage(selected);
    //     console.log(selected);
    // };
    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center gap-x-1 lg:gap-x-2 mb-1 -mt-3 md:mt-0">
                ...
                />
                <InputSearch hintText="Rechercher un sondage" onSubmit={() => { }} />
            </div>
            {/*! bouton creer ajouter un nouvel ... et search bar */}
            ...
            <div className="rounded-sm border border-stroke bg-white px-3 lg:px-5 pt-0 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                <h1 className="text-[12px] lg:text-[15px] mt-3 lg:mt-5 font-medium flex justify-start items-center gap-x-2"><div className="hidden lg:block"><FaFilter /></div>Filtrer la liste des sondages suivant : </h1>
                <div className="block lg:hidden">
                    ...
                    {isDropdownVisible && (
                        <div className="flex flex-col justify-start items-start overflow-y-scroll pb-2 h-[200px] gap-x-2 ">
                            ...
                            {/* <CustomDropDown title="Sondage" items={['1ère année', '2ème année']} defaultValue="1ère année" onSelect={handleSondageSelect} /> */}
                        </div>
                    )}
                </div>
                ...
                <div className="max-w-full overflow-x-auto mt-2 lg:mt-8">
                    <table className="w-full table-auto">
                        ...
                        {
                            !pageIsLoading && <BodyTable data={data} onEdit={onEdit} toDo={toDo}/>
                        }
