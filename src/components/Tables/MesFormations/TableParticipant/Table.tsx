...
import { getTargetedUsers } from "../../../../services/elaborations/themeFormationAPI";
...
const Table = ({ data,currentPage,themeId, onPageChange}: TableUtilisateurProps) => {
        ...
        try{
            ...
            const filterUtilisateurByContent = async () => {
                if (searchText === '') {
                    ...
                    await getTargetedUsers({page:1, themeId:themeId, lang, search:searchText}).then(result=>{
