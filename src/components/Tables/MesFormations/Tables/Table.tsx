...
const Table = ({ data, programmeFormations,isParticipant, formations, currentPage, currentFormation, currentProgrammeFormation, currentFamilleMetier, onPageChange, onFormationChange, onProgrammeFormationChange, onFamilleMetierChange, onDateChange, onResetFilters, onEdit}: TableThemeFormationProps) => {
            ...
            <div className="rounded-sm border border-stroke bg-white px-3 lg:px-5 pt-0 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1 mt-2">
                ...
                <div className="max-w-full overflow-x-auto mt-2 lg:mt-8">
                    <table className="w-full table-auto">
                        ...
                        {/* corp du tableau*/}
                        {
                            !pageIsLoading && <BodyTable data={filteredData} isParticipant={isParticipant}/>
                        }
                    </table>
                </div>
