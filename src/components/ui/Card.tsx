...
export const CardStat = ({ title, value, icon, color = '', footer, isLoading }: CardStatProps) => {
  return (
    isLoading?<Skeleton height={150}/>:(<div className="bg-white dark:bg-boxdark rounded-2xl p-5 shadow-sm border border-stroke hover:shadow-lg transition-all duration-300">
