...
const Bouton = ({ typeReset, iconeSmall, typeRefresh, titreBouton, onClick, outline = false, circle = false, style }: BoutonProps) => {
    ...
    return (
        ...
        ${circle ? `rounded-full ${iconeSmall && !style ? "h-8 w-8" : style ? style : "h-10 w-10"}` : "rounded     w-[50px] h-[35px] lg:h-[41.5px]  lg:min-w-[210px]  lg:w-auto  text-[11.5px] lg:text-sm md:text-md gap-2 my-2   px-4        "}
